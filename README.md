...
- [x] Настройка автоматизирована через **Ansible**.
- [x] Репозитории CentOS 7 переключены на Vault (т.к. зеркала отключены).
...
vagrant up
```
*В процессе Ansible сам починит репозитории и настроит конфиги Bind.*
