...
- [x] Split-DNS работает (проверено через `ping`). Результаты см. на скриншоте 🖼️ [dns_result.png](https://github.com/kamil1403/otus_dns/blob/master/otus_dns_1.png)
...
ping -c 2 www.newdns.lab    # Ошибка
```
